...
{
    std::ifstream bin_file("./Constant/Constant_2011_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2885
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2885_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_2885(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2885_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2885_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2065_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2491_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3136_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3114_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2665
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2665_0	type: float	shape: Shape{128, 128, 1, 1}
void Constant_float_cuda_Constant_2665(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2665_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2665_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[65536];
    bin_file.read(tmp_mem, 65536);
...
// Node name:	Constant_2784
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2784_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2784(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2784_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2784_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2230_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1459<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1451_0, Constant_2569_0, Convolution_1459_0);
// Convolution_float_float_float_cuda_Convolution_1457<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1450_0, Constant_2566_0, Convolution_1457_0);
// Convolution_float_float_float_cuda_Convolution_1455<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1449_0, Constant_2563_0, Convolution_1455_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3135<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1434_0, Constant_2557_0, Constant_3136_0, Relu_1452_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3137<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1435_0, Constant_2560_0, Constant_3138_0, Relu_1453_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1457 : Convolution_float_float_float_cuda_Convolution_1459
// Convolution_float_float_float_cuda_Convolution_1455 : Convolution_float_float_float_cuda_Convolution_1459
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3137 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3135

// Node name:	Convolution_1459
...
// Output:
//	- name: Convolution_1459_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1459_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Node name:	Matched_Pattern_3135
...
// Output:
//	- name: Relu_1452_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3135_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_135(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[1536];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1459_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1459_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        Convolution_float_float_float_cuda_Convolution_1459_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 128 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 255)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3135_block_kernel(input6, input7, input8, output3, threadIdx.x, blockIdx.x - 192 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 319)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3135_block_kernel(input9, input10, input11, output4, threadIdx.x, blockIdx.x - 256 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_135_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* output0, float* output1, float* output2, float* output3, float* output4) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_135<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10, input11, output0, output1, output2, output3, output4);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1580<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1575_0, Constant_35_0, DepthwiseConv2dNative_1580_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1581<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1576_0, Constant_434_0, DepthwiseConv2dNative_1581_0);
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_62<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1583_0, Constant_2812_0, Convolution_1587_0, Constant_2957_0, Add_1597_0);
// Add_float_float_float_cuda_Add_2640<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1585_0, Constant_2814_0, BatchNormInference_1593_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: DepthwiseConv2dNative_1580_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1580_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1581_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1581_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
//	- name: Add_1597_0	type: float	shape: Shape{1, 128, 8, 8}
// Fused functions:
// Add_float_float_float_cuda_Add_2637<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1583_0, Constant_2812_0, BatchNormInference_1592_0);
// Add_float_float_float_cuda_Add_2643<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1587_0, Constant_2957_0, BatchNormInference_1594_0);
// Add_float_float_float_cuda_Add_1597<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_1592_0, BatchNormInference_1594_0, Add_1597_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_62_block_kernel(float* input0, float* input1, float* input2, float* input3, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: BatchNormInference_1593_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Add_float_float_float_cuda_Add_2640_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_fused_kernel_Add_154(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1580_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1581_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 143)
    {
        FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_62_block_kernel(input5, input4, input7, input6, output2, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 144 && (int)blockIdx.x <= 159)
    {
        Add_float_float_float_cuda_Add_2640_block_kernel(input8, input9, output3, threadIdx.x, blockIdx.x - 144 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_fused_kernel_Add_154_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_fused_kernel_Add_154<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1215<<<dim3(1, 16, 4), dim3(16, 1, 16), 0, 0>>>(Relu_1213_0, Constant_2437_0, Convolution_1215_0);
// Convolution_float_float_float_cuda_Convolution_1217<<<dim3(1, 16, 4), dim3(16, 1, 16), 0, 0>>>(Relu_1213_0, Constant_2440_0, Convolution_1217_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1217 : Convolution_float_float_float_cuda_Convolution_1215
...
// Output:
//	- name: Convolution_1215_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1215_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_101(float* input0, float* input1, float* input2, float* output0, float* output1)
{
    __shared__ char shared_buffer[6144];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1215_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1215_block_kernel(input0, input2, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_101_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_101<<<grids, blocks, mem, stream>>>(input0, input1, input2, output0, output1);
}
