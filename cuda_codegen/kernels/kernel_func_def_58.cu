...
{
    std::ifstream bin_file("./Constant/Constant_2374_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3172_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2695
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2695_0	type: float	shape: Shape{128, 128, 1, 1}
void Constant_float_cuda_Constant_2695(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2695_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2695_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_3144_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2760
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2760_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2760(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2760_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2760_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2104_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2098_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
void Constant_float_cuda_Constant_2110(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2110_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2269_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3056_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2886
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2886_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_2886(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2886_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2886_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[65536];
    bin_file.read(tmp_mem, 65536);
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1425<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1420_0, Constant_449_0, DepthwiseConv2dNative_1425_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1424<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1420_0, Constant_231_0, DepthwiseConv2dNative_1424_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1423<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1420_0, Constant_385_0, DepthwiseConv2dNative_1423_0);
// Slice_float_float_cuda_Slice_1421<<<dim3(128, 1, 1), dim3(64, 1, 1), 0, 0>>>(BatchNormInference_1418_0, Slice_1421_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1423 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1424
...
// Output:
//	- name: DepthwiseConv2dNative_1425_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1425_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Node name:	DepthwiseConv2dNative_1424
// Description:	DepthwiseConv2dNative
// Input:
//	- name: Relu_1420_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: Constant_231_0	type: float	shape: Shape{3, 3, 128, 1}
// Output:
//	- name: DepthwiseConv2dNative_1424_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1424_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: Slice_1421_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Slice_float_float_cuda_Slice_1421_block_kernel(float* input0, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 64){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_132(float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1425_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1424_block_kernel(input0, input2, output1, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1424_block_kernel(input0, input3, output2, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 319)
    {
        Slice_float_float_cuda_Slice_1421_block_kernel(input4, output3, threadIdx.x, blockIdx.x - 192 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_132_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_132<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
// Output:
//	- name: Add_822_0	type: float	shape: Shape{1, 32, 32, 32}
//	- name: Add_823_0	type: float	shape: Shape{1, 32, 32, 32}
// Fused functions:
// FusedKernel_float_float_float_float_cuda_Add_Add_21<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_813_0, Constant_2861_0, Slice_769_0, Add_822_0);
// FusedKernel_float_float_float_float_cuda_Add_Add_22<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_815_0, Constant_2859_0, BatchNormInference_749_0, Add_823_0);
// Deduped function map: <src_function_name : deduped_function_name>
// FusedKernel_float_float_float_float_cuda_Add_Add_22 : FusedKernel_float_float_float_float_cuda_Add_Add_21
...
//	- name: Add_822_0	type: float	shape: Shape{1, 32, 32, 32}
// Fused functions:
// Add_float_float_float_cuda_Add_2220<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_813_0, Constant_2861_0, BatchNormInference_819_0);
// Add_float_float_float_cuda_Add_822<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_819_0, Slice_769_0, Add_822_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_cuda_Add_Add_21_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_44(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        FusedKernel_float_float_float_float_cuda_Add_Add_21_block_kernel(input1, input0, input2, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        FusedKernel_float_float_float_float_cuda_Add_Add_21_block_kernel(input4, input3, input5, output1, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_44_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_44<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, output0, output1);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1328<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1322_0, Constant_2503_0, Convolution_1328_0);
// Convolution_float_float_float_cuda_Convolution_1330<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1323_0, Constant_2506_0, Convolution_1330_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1330 : Convolution_float_float_float_cuda_Convolution_1328
...
// Output:
//	- name: Convolution_1328_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1328_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_117(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{
    __shared__ char shared_buffer[2048];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1328_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1328_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_117_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_117<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1);
}
