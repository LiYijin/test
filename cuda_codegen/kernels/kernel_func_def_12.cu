...
{
    std::ifstream bin_file("./Constant/Constant_2572_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2875
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2875_0	type: float	shape: Shape{1, 128, 8, 8}
void Constant_float_cuda_Constant_2875(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2875_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2875_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2518_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2797
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2797_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_2797(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2797_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2797_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[65536];
    bin_file.read(tmp_mem, 65536);
...
{
    std::ifstream bin_file("./Constant/Constant_2128_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3010_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2849
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2849_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2849(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2849_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2849_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[131072];
    bin_file.read(tmp_mem, 131072);
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1648<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1640_0, Constant_2677_0, Convolution_1648_0);
// Convolution_float_float_float_cuda_Convolution_1644<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1638_0, Constant_2671_0, Convolution_1644_0);
// Convolution_float_float_float_cuda_Convolution_1646<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1639_0, Constant_2674_0, Convolution_1646_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1624_0, Constant_2665_0, Constant_3166_0, Relu_1641_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3167<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1625_0, Constant_2668_0, Constant_3168_0, Relu_1642_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1644 : Convolution_float_float_float_cuda_Convolution_1648
// Convolution_float_float_float_cuda_Convolution_1646 : Convolution_float_float_float_cuda_Convolution_1648
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3167 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165

// Node name:	Convolution_1648
...
// Output:
//	- name: Convolution_1648_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1648_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Node name:	Matched_Pattern_3165
...
// Output:
//	- name: Relu_1641_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_162(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[1536];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1648_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1648_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        Convolution_float_float_float_cuda_Convolution_1648_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 128 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 255)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165_block_kernel(input6, input7, input8, output3, threadIdx.x, blockIdx.x - 192 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 319)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3165_block_kernel(input9, input10, input11, output4, threadIdx.x, blockIdx.x - 256 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_162_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* output0, float* output1, float* output2, float* output3, float* output4) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_162<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10, input11, output0, output1, output2, output3, output4);
}
...
void AvgPool_float_float_cuda_lib_AvgPool_509(cudnnHandle_t cudnn_handle, float* input0, float* output0)
{
    cudnnTensorDescriptor_t input_desc;
    CUDNN_SAFE_CALL(cudnnCreateTensorDescriptor(&input_desc));
    CUDNN_SAFE_CALL(cudnnSetTensor4dDescriptor(input_desc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, 1, 32, 32, 32));
    cudnnTensorDescriptor_t output_desc;
    CUDNN_SAFE_CALL(cudnnCreateTensorDescriptor(&output_desc));
    CUDNN_SAFE_CALL(cudnnSetTensor4dDescriptor(output_desc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, 1, 32, 32, 32));
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1513<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1508_0, Constant_144_0, DepthwiseConv2dNative_1513_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1514<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1509_0, Constant_140_0, DepthwiseConv2dNative_1514_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1512<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1507_0, Constant_458_0, DepthwiseConv2dNative_1512_0);
// Add_float_float_float_cuda_Add_1497<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(AvgPool_1489_0, BatchNormInference_1417_0, Add_1497_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1498<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1490_0, Constant_203_0, DepthwiseConv2dNative_1498_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1499<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1490_0, Constant_431_0, DepthwiseConv2dNative_1499_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1512 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1514
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1498 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1513
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1499 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1514
...
// Output:
//	- name: DepthwiseConv2dNative_1513_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1513_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1514_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1514_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: Add_1497_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Add_float_float_float_cuda_Add_1497_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_DepthwiseConv2dNative_DepthwiseConv2dNative_143(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* output0, float* output1, float* output2, float* output3, float* output4, float* output5)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1513_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1514_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1514_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 207)
    {
        Add_float_float_float_cuda_Add_1497_block_kernel(input6, input7, output3, threadIdx.x, blockIdx.x - 192 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 208 && (int)blockIdx.x <= 271)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1513_block_kernel(input8, input9, output4, threadIdx.x, blockIdx.x - 208 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 272 && (int)blockIdx.x <= 335)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1514_block_kernel(input8, input10, output5, threadIdx.x, blockIdx.x - 272 + 0, NULL);
    }
...
// Fused functions:
// Add_float_float_float_cuda_Add_2292<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_957_0, Constant_2885_0, BatchNormInference_958_0);
// Add_float_float_float_cuda_Add_959<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_958_0, MaxPool_898_0, Add_959_0);
extern "C" __launch_bounds__(512) __global__ void FusedKernel_float_float_float_float_cuda_Add_Add_27(float* input0, float* input1, float* input2, float* output0)
{
...
extern void FusedKernel_float_float_float_float_cuda_Add_Add_27_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* output0) {
    FusedKernel_float_float_float_float_cuda_Add_Add_27<<<grids, blocks, mem, stream>>>(input0, input1, input2, output0);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1193<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1187_0, Constant_2422_0, Convolution_1193_0);
// Convolution_float_float_float_cuda_Convolution_1197<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1189_0, Constant_2428_0, Convolution_1197_0);
// Convolution_float_float_float_cuda_Convolution_1195<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1188_0, Constant_2425_0, Convolution_1195_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1173_0, Constant_2416_0, Constant_3094_0, Relu_1190_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3095<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1174_0, Constant_2419_0, Constant_3096_0, Relu_1191_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1197 : Convolution_float_float_float_cuda_Convolution_1193
// Convolution_float_float_float_cuda_Convolution_1195 : Convolution_float_float_float_cuda_Convolution_1193
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3095 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093

// Node name:	Convolution_1193
// Description:	Convolution
// Input:
//	- name: DepthwiseConv2dNative_1187_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2422_0	type: float	shape: Shape{64, 64, 1, 1}
// Output:
//	- name: Convolution_1193_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1193_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
// Node name:	Matched_Pattern_3093
// Description:	Matched_Pattern
// Input:
//	- name: DepthwiseConv2dNative_1173_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2416_0	type: float	shape: Shape{64, 64, 1, 1}
...
// Output:
//	- name: Relu_1190_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_97(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[2048];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1193_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1193_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        Convolution_float_float_float_cuda_Convolution_1193_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 128 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 255)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093_block_kernel(input6, input7, input8, output3, threadIdx.x, blockIdx.x - 192 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 319)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3093_block_kernel(input9, input10, input11, output4, threadIdx.x, blockIdx.x - 256 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_97_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* output0, float* output1, float* output2, float* output3, float* output4) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Matched_Pattern_Matched_Pattern_97<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, input10, input11, output0, output1, output2, output3, output4);
}
...
{
    std::ifstream bin_file("./Constant/Constant_1935_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
