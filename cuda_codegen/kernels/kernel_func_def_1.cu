...
// Input:
// Output:
//	- name: Constant_249_0	type: float	shape: Shape{3, 3, 128, 1}
...
// Node name:	Constant_3100
// Description:	Constant
// Input:
// Output:
//	- name: Constant_3100_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_3100(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_3100_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_3100_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2494_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2920
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2920_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_2920(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2920_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2920_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[65536];
    bin_file.read(tmp_mem, 65536);
...
{
    std::ifstream bin_file("./Constant/Constant_2101_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2371_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3026_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3058_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Output:
//	- name: DepthwiseConv2dNative_946_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_934_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_935_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_936_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_946<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_938_0, Constant_29_0, DepthwiseConv2dNative_946_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_934<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_930_0, Constant_325_0, DepthwiseConv2dNative_934_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_935<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_931_0, Constant_148_0, DepthwiseConv2dNative_935_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_936<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_932_0, Constant_171_0, DepthwiseConv2dNative_936_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_935 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_946
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_936 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_946
...
// Output:
//	- name: DepthwiseConv2dNative_946_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_946_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_934_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_934_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_62(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_946_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 255)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_934_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 383)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_946_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 256 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 384 && (int)blockIdx.x <= 511)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_946_block_kernel(input6, input7, output3, threadIdx.x, blockIdx.x - 384 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_62_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_62<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
//	- name: Constant_340_0	type: float	shape: Shape{3, 3, 32, 1}
...
// Fused functions:
// Add_float_float_float_cuda_Add_595<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(AvgPool_587_0, BatchNormInference_488_0, Add_595_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_596<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_588_0, Constant_340_0, DepthwiseConv2dNative_596_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_597<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_588_0, Constant_322_0, DepthwiseConv2dNative_597_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_612<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_607_0, Constant_251_0, DepthwiseConv2dNative_612_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_610<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_605_0, Constant_236_0, DepthwiseConv2dNative_610_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_611<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_606_0, Constant_177_0, DepthwiseConv2dNative_611_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_612 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_597
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_610 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_596
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_611 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_596
...
// Output:
//	- name: Add_595_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Add_float_float_float_cuda_Add_595_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_596_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_596_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_597_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_597_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_13(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* output0, float* output1, float* output2, float* output3, float* output4, float* output5)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Add_float_float_float_cuda_Add_595_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 319)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_596_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 320 && (int)blockIdx.x <= 575)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_597_block_kernel(input2, input4, output2, threadIdx.x, blockIdx.x - 320 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 576 && (int)blockIdx.x <= 831)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_597_block_kernel(input5, input6, output3, threadIdx.x, blockIdx.x - 576 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 832 && (int)blockIdx.x <= 1087)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_596_block_kernel(input7, input8, output4, threadIdx.x, blockIdx.x - 832 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 1088 && (int)blockIdx.x <= 1343)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_596_block_kernel(input9, input10, output5, threadIdx.x, blockIdx.x - 1088 + 0, NULL);
    }
...
//	- name: Constant_8_0	type: float	shape: Shape{3, 3, 128, 1}
//	- name: Constant_438_0	type: float	shape: Shape{3, 3, 128, 1}
//	- name: BatchNormInference_1607_0	type: float	shape: Shape{1, 128, 8, 8}
// Output:
//	- name: DepthwiseConv2dNative_1613_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: DepthwiseConv2dNative_1611_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: DepthwiseConv2dNative_1612_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: Slice_1610_0	type: float	shape: Shape{1, 128, 8, 8}
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1613<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1608_0, Constant_397_0, DepthwiseConv2dNative_1613_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1611<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1608_0, Constant_8_0, DepthwiseConv2dNative_1611_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1612<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1608_0, Constant_438_0, DepthwiseConv2dNative_1612_0);
// Slice_float_float_cuda_Slice_1610<<<dim3(128, 1, 1), dim3(64, 1, 1), 0, 0>>>(BatchNormInference_1607_0, Slice_1610_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1612 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1611
...
// Output:
//	- name: DepthwiseConv2dNative_1613_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1613_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1611_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1611_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: Slice_1610_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Slice_float_float_cuda_Slice_1610_block_kernel(float* input0, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 64){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_159(float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1613_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1611_block_kernel(input0, input2, output1, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1611_block_kernel(input0, input3, output2, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 319)
    {
        Slice_float_float_cuda_Slice_1610_block_kernel(input4, output3, threadIdx.x, blockIdx.x - 192 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_159_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_159<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1129<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1124_0, Constant_349_0, DepthwiseConv2dNative_1129_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1130<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1125_0, Constant_432_0, DepthwiseConv2dNative_1130_0);
// Add_float_float_float_cuda_Add_2394<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1136_0, Constant_2759_0, BatchNormInference_1143_0);
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_37<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1132_0, Constant_2908_0, Convolution_1134_0, Constant_2758_0, Add_1146_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: DepthwiseConv2dNative_1129_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1129_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1130_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1130_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: BatchNormInference_1143_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Add_float_float_float_cuda_Add_2394_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
//	- name: Add_1146_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2388<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1132_0, Constant_2908_0, BatchNormInference_1141_0);
// Add_float_float_float_cuda_Add_2391<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1134_0, Constant_2758_0, BatchNormInference_1142_0);
// Add_float_float_float_cuda_Add_1146<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_1141_0, BatchNormInference_1142_0, Add_1146_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_37_block_kernel(float* input0, float* input1, float* input2, float* input3, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_fused_kernel_89(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1129_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 255)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1130_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 287)
    {
        Add_float_float_float_cuda_Add_2394_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 256 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 288 && (int)blockIdx.x <= 319)
    {
        FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_37_block_kernel(input7, input6, input9, input8, output3, threadIdx.x, blockIdx.x - 288 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_fused_kernel_89_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_fused_kernel_89<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_638<<<dim3(1, 32, 2), dim3(32, 1, 8), 0, 0>>>(Relu_636_0, Constant_2116_0, Convolution_638_0);
// Convolution_float_float_float_cuda_Convolution_640<<<dim3(1, 32, 2), dim3(32, 1, 8), 0, 0>>>(Relu_636_0, Constant_2119_0, Convolution_640_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_640 : Convolution_float_float_float_cuda_Convolution_638
...
// Output:
//	- name: Convolution_638_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_638_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_18(float* input0, float* input1, float* input2, float* output0, float* output1)
{
    __shared__ char shared_buffer[9216];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_638_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_638_block_kernel(input0, input2, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_18_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_18<<<grids, blocks, mem, stream>>>(input0, input1, input2, output0, output1);
}
