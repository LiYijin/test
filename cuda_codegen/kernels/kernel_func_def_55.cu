...
{
    std::ifstream bin_file("./Constant/Constant_2822_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2380_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3154_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_3132
// Description:	Constant
// Input:
// Output:
//	- name: Constant_3132_0	type: float	shape: Shape{1, 128, 8, 8}
void Constant_float_cuda_Constant_3132(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_3132_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_3132_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[32768];
    bin_file.read(tmp_mem, 32768);
...
{
    std::ifstream bin_file("./Constant/Constant_2074_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3002_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2164_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1035<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1031_0, Constant_16_0, DepthwiseConv2dNative_1035_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1036<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1031_0, Constant_182_0, DepthwiseConv2dNative_1036_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1034<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1031_0, Constant_97_0, DepthwiseConv2dNative_1034_0);
// Slice_float_float_cuda_Slice_1033<<<dim3(256, 1, 1), dim3(64, 1, 1), 0, 0>>>(BatchNormInference_1030_0, Slice_1033_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1036 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1035

// Node name:	DepthwiseConv2dNative_1035
...
// Output:
//	- name: DepthwiseConv2dNative_1035_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1035_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1034_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1034_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: Slice_1033_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Slice_float_float_cuda_Slice_1033_block_kernel(float* input0, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 64){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_76(float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1035_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 255)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1035_block_kernel(input0, input2, output1, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 383)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1034_block_kernel(input0, input3, output2, threadIdx.x, blockIdx.x - 256 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 384 && (int)blockIdx.x <= 639)
    {
        Slice_float_float_cuda_Slice_1033_block_kernel(input4, output3, threadIdx.x, blockIdx.x - 384 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_76_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Slice_76<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1389<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1384_0, Constant_2527_0, Convolution_1389_0);
// Convolution_float_float_float_cuda_Convolution_1391<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1385_0, Constant_2530_0, Convolution_1391_0);
// Convolution_float_float_float_cuda_Convolution_1393<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1386_0, Constant_2533_0, Convolution_1393_0);
// Add_float_float_float_cuda_Add_1399<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_1355_0, AvgPool_1394_0, Add_1399_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3127<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1400_0, Constant_2536_0, Constant_3128_0, Relu_1405_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1391 : Convolution_float_float_float_cuda_Convolution_1389
// Convolution_float_float_float_cuda_Convolution_1393 : Convolution_float_float_float_cuda_Convolution_1389
...
// Output:
//	- name: Convolution_1389_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1389_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: Add_1399_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Add_float_float_float_cuda_Add_1399_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: Relu_1405_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3127_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_Convolution_Convolution_Add_Matched_Pattern_128(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[1536];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1389_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1389_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        Convolution_float_float_float_cuda_Convolution_1389_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 128 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 207)
    {
        Add_float_float_float_cuda_Add_1399_block_kernel(input6, input7, output3, threadIdx.x, blockIdx.x - 192 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 208 && (int)blockIdx.x <= 271)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3127_block_kernel(input8, input9, input10, output4, threadIdx.x, blockIdx.x - 208 + 0, shared_buffer);
    }
...
// Fused functions:
// FusedKernel_float_float_float_float_cuda_Add_Add_46<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1264_0, Constant_2802_0, Slice_1220_0, Add_1273_0);
// FusedKernel_float_float_float_float_cuda_Add_Add_47<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1266_0, Constant_2803_0, BatchNormInference_1202_0, Add_1274_0);
// Deduped function map: <src_function_name : deduped_function_name>
// FusedKernel_float_float_float_float_cuda_Add_Add_47 : FusedKernel_float_float_float_float_cuda_Add_Add_46
...
//	- name: Add_1273_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2469<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1264_0, Constant_2802_0, BatchNormInference_1270_0);
// Add_float_float_float_cuda_Add_1273<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_1270_0, Slice_1220_0, Add_1273_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_cuda_Add_Add_46_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_109(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31)
    {
        FusedKernel_float_float_float_float_cuda_Add_Add_46_block_kernel(input1, input0, input2, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 63)
    {
        FusedKernel_float_float_float_float_cuda_Add_Add_46_block_kernel(input4, input3, input5, output1, threadIdx.x, blockIdx.x - 32 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_109_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_109<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, output0, output1);
}
