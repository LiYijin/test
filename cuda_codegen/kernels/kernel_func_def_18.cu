...
{
    std::ifstream bin_file("./Constant/Constant_3178_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2635_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2861
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2861_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2861(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2861_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2861_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2452_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2056
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2056_0	type: float	shape: Shape{32, 32, 1, 1}
void Constant_float_cuda_Constant_2056(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2056_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2056_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_3064_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3012_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2428_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Input:
// Output:
//	- name: Constant_2859_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2859(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2859_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2245_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2290_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Input:
//	- name: Convolution_1197_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2919_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Convolution_1193_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2976_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2914_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Convolution_1195_0	type: float	shape: Shape{1, 64, 16, 16}
...
// Output:
//	- name: BatchNormInference_1202_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Add_1207_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_1198_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_1199_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2430<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1197_0, Constant_2919_0, BatchNormInference_1202_0);
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_41<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1193_0, Constant_2976_0, Convolution_1195_0, Constant_2914_0, Add_1207_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1198<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1190_0, Constant_241_0, DepthwiseConv2dNative_1198_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1199<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1191_0, Constant_155_0, DepthwiseConv2dNative_1199_0);
...
// Output:
//	- name: BatchNormInference_1202_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Add_float_float_float_cuda_Add_2430_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
//	- name: Add_1207_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2424<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1193_0, Constant_2976_0, BatchNormInference_1200_0);
// Add_float_float_float_cuda_Add_2427<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1195_0, Constant_2914_0, BatchNormInference_1201_0);
// Add_float_float_float_cuda_Add_1207<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_1201_0, BatchNormInference_1200_0, Add_1207_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_41_block_kernel(float* input0, float* input1, float* input2, float* input3, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1198_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1198_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1199_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1199_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_fused_kernel_DepthwiseConv2dNative_DepthwiseConv2dNative_98(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31)
    {
        Add_float_float_float_cuda_Add_2430_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 63)
    {
        FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_41_block_kernel(input2, input3, input5, input4, output1, threadIdx.x, blockIdx.x - 32 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 191)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1198_block_kernel(input6, input7, output2, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 319)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1199_block_kernel(input8, input9, output3, threadIdx.x, blockIdx.x - 192 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_fused_kernel_DepthwiseConv2dNative_DepthwiseConv2dNative_98_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_fused_kernel_DepthwiseConv2dNative_DepthwiseConv2dNative_98<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Add_float_float_float_cuda_Add_1614<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(AvgPool_1609_0, AvgPool_1609_0, Add_1614_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3163<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1613_0, Constant_2662_0, Constant_3164_0, Relu_1635_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3159<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1611_0, Constant_2656_0, Constant_3160_0, Relu_1633_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3161<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1612_0, Constant_2659_0, Constant_3162_0, Relu_1634_0);
// Relu_float_float_cuda_Relu_1616<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Slice_1610_0, Relu_1616_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3159 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3163
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3161 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3163
...
// Output:
//	- name: Add_1614_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Add_float_float_float_cuda_Add_1614_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: Relu_1635_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3163_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: Relu_1616_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Relu_float_float_cuda_Relu_1616_block_kernel(float* input0, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Add_Matched_Pattern_Matched_Pattern_Matched_Pattern_Relu_160(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[1536];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 15)
    {
        Add_float_float_float_cuda_Add_1614_block_kernel(input0, input0, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 16 && (int)blockIdx.x <= 79)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3163_block_kernel(input1, input2, input3, output1, threadIdx.x, blockIdx.x - 16 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 80 && (int)blockIdx.x <= 143)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3163_block_kernel(input4, input5, input6, output2, threadIdx.x, blockIdx.x - 80 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 144 && (int)blockIdx.x <= 207)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3163_block_kernel(input7, input8, input9, output3, threadIdx.x, blockIdx.x - 144 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 208 && (int)blockIdx.x <= 223)
    {
        Relu_float_float_cuda_Relu_1616_block_kernel(input10, output4, threadIdx.x, blockIdx.x - 208 + 0, shared_buffer);
    }
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_836<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_832_0, Constant_442_0, DepthwiseConv2dNative_836_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_834<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_832_0, Constant_71_0, DepthwiseConv2dNative_834_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_835<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_832_0, Constant_101_0, DepthwiseConv2dNative_835_0);
// Add_float_float_float_cuda_Add_2229<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_829_0, Constant_2742_0, BatchNormInference_831_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_835 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_836
...
// Output:
//	- name: DepthwiseConv2dNative_836_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_836_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_834_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_834_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: BatchNormInference_831_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Add_float_float_float_cuda_Add_2229_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_46(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_836_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 255)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_834_block_kernel(input0, input2, output1, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 383)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_836_block_kernel(input0, input3, output2, threadIdx.x, blockIdx.x - 256 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 384 && (int)blockIdx.x <= 447)
    {
        Add_float_float_float_cuda_Add_2229_block_kernel(input4, input5, output3, threadIdx.x, blockIdx.x - 384 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_46_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_46<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, output0, output1, output2, output3);
}
