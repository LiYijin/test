...
{
    std::ifstream bin_file("./Constant/Constant_2764_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2836_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2554_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2918
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2918_0	type: float	shape: Shape{1, 64, 16, 16}
void Constant_float_cuda_Constant_2918(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2918_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2918_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[65536];
    bin_file.read(tmp_mem, 65536);
...
{
    std::ifstream bin_file("./Constant/Constant_2377_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3060_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3110_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2197_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2683_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2876
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2876_0	type: float	shape: Shape{1, 128, 8, 8}
void Constant_float_cuda_Constant_2876(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2876_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2876_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[32768];
    bin_file.read(tmp_mem, 32768);
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1012<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1003_0, Constant_2323_0, Convolution_1012_0);
// Convolution_float_float_float_cuda_Convolution_1014<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1004_0, Constant_2326_0, Convolution_1014_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1014 : Convolution_float_float_float_cuda_Convolution_1012
...
// Output:
//	- name: Convolution_1012_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1012_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_72(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{
    __shared__ char shared_buffer[2048];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1012_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1012_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_72_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_72<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Relu_float_float_cuda_Relu_588<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Slice_582_0, Relu_588_0);
// Add_float_float_float_cuda_Add_586<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(AvgPool_581_0, AvgPool_581_0, Add_586_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2999<<<dim3(2, 16, 2), dim3(16, 2, 8), 0, 0>>>(DepthwiseConv2dNative_585_0, Constant_2092_0, Constant_3000_0, Relu_607_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2995<<<dim3(2, 16, 2), dim3(16, 2, 8), 0, 0>>>(DepthwiseConv2dNative_583_0, Constant_2086_0, Constant_2996_0, Relu_605_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2997<<<dim3(2, 16, 2), dim3(16, 2, 8), 0, 0>>>(DepthwiseConv2dNative_584_0, Constant_2089_0, Constant_2998_0, Relu_606_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2995 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2999
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2997 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2999
...
// Output:
//	- name: Relu_588_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Relu_float_float_cuda_Relu_588_block_kernel(float* input0, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: Add_586_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Add_float_float_float_cuda_Add_586_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: Relu_607_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2999_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Relu_Add_Matched_Pattern_Matched_Pattern_Matched_Pattern_12(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[3072];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Relu_float_float_cuda_Relu_588_block_kernel(input0, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Add_float_float_float_cuda_Add_586_block_kernel(input1, input1, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2999_block_kernel(input2, input3, input4, output2, threadIdx.x, blockIdx.x - 128 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 255)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2999_block_kernel(input5, input6, input7, output3, threadIdx.x, blockIdx.x - 192 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 319)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_2999_block_kernel(input8, input9, input10, output4, threadIdx.x, blockIdx.x - 256 + 0, shared_buffer);
    }
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_871<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_863_0, Constant_263_0, DepthwiseConv2dNative_871_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_872<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_864_0, Constant_161_0, DepthwiseConv2dNative_872_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: DepthwiseConv2dNative_871_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_871_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_872_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_872_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_51(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 255)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_871_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 511)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_872_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 256 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_51_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_51<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1);
}
