...
{
    std::ifstream bin_file("./Constant/Constant_2917_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2224_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
void Constant_float_cuda_Constant_2984(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2984_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2653_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2959
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2959_0	type: float	shape: Shape{1, 128, 8, 8}
void Constant_float_cuda_Constant_2959(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2959_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2959_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2931_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2966_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
//	- name: Constant_111_0	type: float	shape: Shape{5, 5, 128, 1}
...
// Fused functions:
// Slice_float_float_cuda_Slice_1545<<<dim3(128, 1, 1), dim3(64, 1, 1), 0, 0>>>(BatchNormInference_1543_0, Slice_1545_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1550<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1546_0, Constant_111_0, DepthwiseConv2dNative_1550_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1552<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1546_0, Constant_264_0, DepthwiseConv2dNative_1552_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1551<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1546_0, Constant_249_0, DepthwiseConv2dNative_1551_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1551 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1552
...
// Output:
//	- name: Slice_1545_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Slice_float_float_cuda_Slice_1545_block_kernel(float* input0, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 64){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1550_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1550_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1552_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1552_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_Slice_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_150(float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 127)
    {
        Slice_float_float_cuda_Slice_1545_block_kernel(input0, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1550_block_kernel(input1, input2, output1, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 255)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1552_block_kernel(input1, input3, output2, threadIdx.x, blockIdx.x - 192 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 319)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1552_block_kernel(input1, input4, output3, threadIdx.x, blockIdx.x - 256 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_Slice_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_150_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_cuda_Slice_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_150<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, output0, output1, output2, output3);
}
// Node name:	 BlockFusion
// Input:
...
//	- name: Convolution_829_0	type: float	shape: Shape{1, 32, 32, 32}
// Fused functions:
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3035<<<dim3(1, 32, 2), dim3(16, 1, 16), 0, 0>>>(Relu_825_0, Constant_2224_0, Constant_3036_0, Relu_832_0);
// Convolution_float_float_float_cuda_Convolution_829<<<dim3(1, 32, 2), dim3(32, 1, 8), 0, 0>>>(Relu_825_0, Constant_2227_0, Convolution_829_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: Relu_832_0	type: float	shape: Shape{1, 64, 32, 32}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3035_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
    ...
    float* input1_shared = (float*)(shared_buffer + 3072);
    {
        float* compute = output0;{
          ...
          for (int i1_inner_inner_inner = 0; i1_inner_inner_inner < 2; ++i1_inner_inner_inner) {
            compute[(((((((int)blockIdx.z) * 32768) + (((int)threadIdx.z) * 2048)) + (i1_inner_inner_inner * 1024)) + (((int)blockIdx.y) * 32)) + ((int)threadIdx.x))] = max((compute1[i1_inner_inner_inner] + input2[(((((int)blockIdx.z) * 32) + (((int)threadIdx.z) * 2)) + i1_inner_inner_inner)]), 0.000000e+00f);
            compute[((((((((int)blockIdx.z) * 32768) + (((int)threadIdx.z) * 2048)) + (i1_inner_inner_inner * 1024)) + (((int)blockIdx.y) * 32)) + ((int)threadIdx.x)) + 16)] = max((compute1[(i1_inner_inner_inner + 2)] + input2[(((((int)blockIdx.z) * 32) + (((int)threadIdx.z) * 2)) + i1_inner_inner_inner)]), 0.000000e+00f);
          }
        }
...
// Output:
//	- name: Convolution_829_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_829_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_Matched_Pattern_Convolution_45(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{
    __shared__ char shared_buffer[9216];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3035_block_kernel(input0, input1, input2, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_829_block_kernel(input0, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_Matched_Pattern_Convolution_45_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_cuda_Matched_Pattern_Convolution_45<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1);
}
// Node name:	 BlockFusion
// Input:
//	- name: Convolution_963_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2888_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2886_0	type: float	shape: Shape{1, 64, 16, 16}
...
// Fused functions:
// Add_float_float_float_cuda_Add_2295<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_963_0, Constant_2888_0, BatchNormInference_966_0);
// FusedKernel_float_float_float_float_cuda_Add_Relu_28<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_965_0, Constant_2886_0, Relu_969_0, BatchNormInference_967_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: BatchNormInference_966_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Add_float_float_float_cuda_Add_2295_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
//	- name: BatchNormInference_967_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2298<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_965_0, Constant_2886_0, BatchNormInference_967_0);
// Relu_float_float_cuda_Relu_969<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_967_0, Relu_969_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_cuda_Add_Relu_28_block_kernel(float* input0, float* input1, float* output0, float* output1, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_cuda_Add_fused_kernel_66(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1, float* output2)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31)
    {
        Add_float_float_float_cuda_Add_2295_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 63)
    {
        FusedKernel_float_float_float_float_cuda_Add_Relu_28_block_kernel(input3, input2, output2, output1, threadIdx.x, blockIdx.x - 32 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_cuda_Add_fused_kernel_66_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1, float* output2) {
    BlockFusionKernel_float_float_float_float_float_float_float_cuda_Add_fused_kernel_66<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1, output2);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_627<<<dim3(2, 16, 2), dim3(16, 2, 8), 0, 0>>>(DepthwiseConv2dNative_621_0, Constant_2110_0, Convolution_627_0);
// Convolution_float_float_float_cuda_Convolution_629<<<dim3(2, 16, 2), dim3(16, 2, 8), 0, 0>>>(DepthwiseConv2dNative_622_0, Constant_2113_0, Convolution_629_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_629 : Convolution_float_float_float_cuda_Convolution_627

// Node name:	Convolution_627
// Description:	Convolution
// Input:
//	- name: DepthwiseConv2dNative_621_0	type: float	shape: Shape{1, 32, 32, 32}
//	- name: Constant_2110_0	type: float	shape: Shape{32, 32, 1, 1}
// Output:
//	- name: Convolution_627_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_627_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_16(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{
    __shared__ char shared_buffer[3072];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_627_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_627_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_16_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_16<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1);
}
// Node name:	 BlockFusion
// Input:
...
// Output:
//	- name: Convolution_925_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_913_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_914_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: DepthwiseConv2dNative_915_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Add_916_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_925<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_917_0, Constant_2266_0, Convolution_925_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_913<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_910_0, Constant_297_0, DepthwiseConv2dNative_913_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_910_0, Constant_200_0, DepthwiseConv2dNative_914_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_915<<<dim3(128, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_910_0, Constant_212_0, DepthwiseConv2dNative_915_0);
// Add_float_float_float_cuda_Add_916<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(AvgPool_911_0, AvgPool_911_0, Add_916_0);
// Deduped function map: <src_function_name : deduped_function_name>
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_915 : DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914

// Node name:	Convolution_925
// Description:	Convolution
// Input:
//	- name: DepthwiseConv2dNative_917_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2266_0	type: float	shape: Shape{64, 64, 1, 1}
// Output:
//	- name: Convolution_925_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_925_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
// Node name:	DepthwiseConv2dNative_913
// Description:	DepthwiseConv2dNative
// Input:
//	- name: Relu_910_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_297_0	type: float	shape: Shape{5, 5, 64, 1}
// Output:
//	- name: DepthwiseConv2dNative_913_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_913_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Node name:	DepthwiseConv2dNative_914
// Description:	DepthwiseConv2dNative
// Input:
//	- name: Relu_910_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_200_0	type: float	shape: Shape{3, 3, 64, 1}
// Output:
//	- name: DepthwiseConv2dNative_914_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: Add_916_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Add_float_float_float_cuda_Add_916_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_60(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[2048];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_925_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 191)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_913_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 192 && (int)blockIdx.x <= 319)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(input2, input4, output2, threadIdx.x, blockIdx.x - 192 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 320 && (int)blockIdx.x <= 447)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_914_block_kernel(input2, input5, output3, threadIdx.x, blockIdx.x - 320 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 448 && (int)blockIdx.x <= 479)
    {
        Add_float_float_float_cuda_Add_916_block_kernel(input6, input6, output4, threadIdx.x, blockIdx.x - 448 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_60_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* output0, float* output1, float* output2, float* output3, float* output4) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_cuda_Convolution_DepthwiseConv2dNative_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_60<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, output0, output1, output2, output3, output4);
}
