...
// Input:
// Output:
//	- name: Constant_434_0	type: float	shape: Shape{5, 5, 128, 1}
...
{
    std::ifstream bin_file("./Constant/Constant_3044_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Input:
// Output:
//	- name: Constant_203_0	type: float	shape: Shape{5, 5, 128, 1}
...
{
    std::ifstream bin_file("./Constant/Constant_2656_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2817
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2817_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2817(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2817_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2817_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[131072];
    bin_file.read(tmp_mem, 131072);
...
{
    std::ifstream bin_file("./Constant/Constant_2152_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2248_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3074_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
//	- name: Convolution_1012_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Slice_968_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Constant_2896_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Convolution_1014_0	type: float	shape: Shape{1, 64, 16, 16}
...
// Fused functions:
// FusedKernel_float_float_float_float_cuda_Add_Add_30<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1012_0, Constant_2895_0, Slice_968_0, Add_1021_0);
// FusedKernel_float_float_float_float_cuda_Add_Add_31<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1014_0, Constant_2896_0, BatchNormInference_948_0, Add_1022_0);
// Deduped function map: <src_function_name : deduped_function_name>
// FusedKernel_float_float_float_float_cuda_Add_Add_31 : FusedKernel_float_float_float_float_cuda_Add_Add_30
...
//	- name: Add_1021_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2325<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1012_0, Constant_2895_0, BatchNormInference_1018_0);
// Add_float_float_float_cuda_Add_1021<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_1018_0, Slice_968_0, Add_1021_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_cuda_Add_Add_30_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_73(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31)
    {
        FusedKernel_float_float_float_float_cuda_Add_Add_30_block_kernel(input1, input0, input2, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 63)
    {
        FusedKernel_float_float_float_float_cuda_Add_Add_30_block_kernel(input4, input3, input5, output1, threadIdx.x, blockIdx.x - 32 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_73_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_fused_kernel_fused_kernel_73<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, output0, output1);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_564<<<dim3(2, 16, 2), dim3(16, 2, 8), 0, 0>>>(DepthwiseConv2dNative_558_0, Constant_2074_0, Convolution_564_0);
// Convolution_float_float_float_cuda_Convolution_566<<<dim3(2, 16, 2), dim3(16, 2, 8), 0, 0>>>(DepthwiseConv2dNative_559_0, Constant_2077_0, Convolution_566_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_566 : Convolution_float_float_float_cuda_Convolution_564
...
// Output:
//	- name: Convolution_564_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_564_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_7(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{
    __shared__ char shared_buffer[3072];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_564_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_564_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_7_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_7<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1152<<<dim3(1, 16, 4), dim3(16, 1, 16), 0, 0>>>(Relu_1150_0, Constant_2401_0, Convolution_1152_0);
// Convolution_float_float_float_cuda_Convolution_1154<<<dim3(1, 16, 4), dim3(16, 1, 16), 0, 0>>>(Relu_1150_0, Constant_2404_0, Convolution_1154_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1154 : Convolution_float_float_float_cuda_Convolution_1152
...
// Output:
//	- name: Convolution_1152_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1152_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_92(float* input0, float* input1, float* input2, float* output0, float* output1)
{
    __shared__ char shared_buffer[6144];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1152_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1152_block_kernel(input0, input2, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_92_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_cuda_Convolution_Convolution_92<<<grids, blocks, mem, stream>>>(input0, input1, input2, output0, output1);
}
// Node name:	 BlockFusion
// Input:
...
// Fused functions:
// BatchNormInference_float_float_float_float_float_float_cuda_BatchNormInference_1357<<<dim3(128, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_353_0, Constant_185_0, Concat_1353_0, Constant_185_0, Constant_353_0, BatchNormInference_1357_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3119<<<dim3(1, 4, 16), dim3(8, 2, 8), 0, 0>>>(DepthwiseConv2dNative_1354_0, Constant_2512_0, Constant_3120_0, Relu_1367_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: BatchNormInference_1357_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void BatchNormInference_float_float_float_float_float_float_cuda_BatchNormInference_1357_block_kernel(float* input0, float* input1, float* input2, float* input3, float* input4, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 64){
        return;
    }
...
// Output:
//	- name: Relu_1367_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3119_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_BatchNormInference_Matched_Pattern_123(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1)
{
    __shared__ char shared_buffer[1536];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 127)
    {
        BatchNormInference_float_float_float_float_float_float_cuda_BatchNormInference_1357_block_kernel(input0, input1, input2, input1, input0, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 191)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3119_block_kernel(input3, input4, input5, output1, threadIdx.x, blockIdx.x - 128 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_BatchNormInference_Matched_Pattern_123_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_cuda_BatchNormInference_Matched_Pattern_123<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, output0, output1);
}
// Node name:	 BlockFusion
// Input:
...
//	- name: Constant_2875_0	type: float	shape: Shape{1, 128, 8, 8}
...
// Output:
//	- name: DepthwiseConv2dNative_1706_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: DepthwiseConv2dNative_1707_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: BatchNormInference_1718_0	type: float	shape: Shape{1, 128, 8, 8}
//	- name: Add_1723_0	type: float	shape: Shape{1, 128, 8, 8}
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1706<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1701_0, Constant_43_0, DepthwiseConv2dNative_1706_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1707<<<dim3(64, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_1702_0, Constant_441_0, DepthwiseConv2dNative_1707_0);
// Add_float_float_float_cuda_Add_2709<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1709_0, Constant_2875_0, BatchNormInference_1718_0);
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_70<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1711_0, Constant_2971_0, Convolution_1713_0, Constant_2970_0, Add_1723_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: DepthwiseConv2dNative_1706_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1706_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_1707_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1707_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: BatchNormInference_1718_0	type: float	shape: Shape{1, 128, 8, 8}
__device__ __noinline__ void Add_float_float_float_cuda_Add_2709_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
//	- name: Add_1723_0	type: float	shape: Shape{1, 128, 8, 8}
// Fused functions:
// Add_float_float_float_cuda_Add_2712<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1711_0, Constant_2971_0, BatchNormInference_1719_0);
// Add_float_float_float_cuda_Add_2715<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_1713_0, Constant_2970_0, BatchNormInference_1720_0);
// Add_float_float_float_cuda_Add_1723<<<dim3(16, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_1720_0, BatchNormInference_1719_0, Add_1723_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_70_block_kernel(float* input0, float* input1, float* input2, float* input3, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_fused_kernel_172(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1706_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_1707_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 128 && (int)blockIdx.x <= 143)
    {
        Add_float_float_float_cuda_Add_2709_block_kernel(input4, input5, output2, threadIdx.x, blockIdx.x - 128 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 144 && (int)blockIdx.x <= 159)
    {
        FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_70_block_kernel(input6, input7, input9, input8, output3, threadIdx.x, blockIdx.x - 144 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_fused_kernel_172_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_Add_fused_kernel_172<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, output0, output1, output2, output3);
}
