...
{
    std::ifstream bin_file("./Constant/Constant_2392_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2930
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2930_0	type: float	shape: Shape{1, 128, 8, 8}
void Constant_float_cuda_Constant_2930(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2930_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2930_0 failed.\n");
    	exit(1);
    }
...
{
    std::ifstream bin_file("./Constant/Constant_2975_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_3098_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
{
    std::ifstream bin_file("./Constant/Constant_2994_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Node name:	Constant_2833
// Description:	Constant
// Input:
// Output:
//	- name: Constant_2833_0	type: float	shape: Shape{1, 32, 32, 32}
void Constant_float_cuda_Constant_2833(cudaStream_t stream, float* output0)
{
    std::ifstream bin_file("./Constant/Constant_2833_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
    	printf("Load Constant_2833_0 failed.\n");
    	exit(1);
    }
    char* tmp_mem = new char[131072];
    bin_file.read(tmp_mem, 131072);
...
{
    std::ifstream bin_file("./Constant/Constant_3042_0.bin" , std::ios::in | std::ios::binary);
    if(bin_file.fail())
    {
...
// Output:
//	- name: Convolution_1078_0	type: float	shape: Shape{1, 64, 16, 16}
//	- name: Convolution_1080_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Convolution_float_float_float_cuda_Convolution_1078<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1072_0, Constant_2359_0, Convolution_1078_0);
// Convolution_float_float_float_cuda_Convolution_1080<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_1073_0, Constant_2362_0, Convolution_1080_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Convolution_float_float_float_cuda_Convolution_1080 : Convolution_float_float_float_cuda_Convolution_1078
...
// Output:
//	- name: Convolution_1078_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Convolution_float_float_float_cuda_Convolution_1078_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_81(float* input0, float* input1, float* input2, float* input3, float* output0, float* output1)
{
    __shared__ char shared_buffer[2048];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 63)
    {
        Convolution_float_float_float_cuda_Convolution_1078_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 64 && (int)blockIdx.x <= 127)
    {
        Convolution_float_float_float_cuda_Convolution_1078_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 64 + 0, shared_buffer);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_81_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* output0, float* output1) {
    BlockFusionKernel_float_float_float_float_float_float_cuda_Convolution_Convolution_81<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, output0, output1);
}
// Node name:	 BlockFusion
// Input:
//	- name: Relu_799_0	type: float	shape: Shape{1, 32, 32, 32}
//	- name: Constant_305_0	type: float	shape: Shape{3, 3, 32, 1}
...
// Fused functions:
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_804<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_799_0, Constant_305_0, DepthwiseConv2dNative_804_0);
// DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_805<<<dim3(256, 1, 1), dim3(128, 1, 1), 0, 0>>>(Relu_800_0, Constant_370_0, DepthwiseConv2dNative_805_0);
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_20<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_807_0, Constant_2855_0, Convolution_811_0, Constant_2858_0, Add_821_0);
// Add_float_float_float_cuda_Add_2214<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_809_0, Constant_2860_0, BatchNormInference_817_0);
// Deduped function map: <src_function_name : deduped_function_name>
...
// Output:
//	- name: DepthwiseConv2dNative_804_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_804_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
// Output:
//	- name: DepthwiseConv2dNative_805_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_805_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 128){
        return;
    }
...
//	- name: Add_821_0	type: float	shape: Shape{1, 32, 32, 32}
// Fused functions:
// Add_float_float_float_cuda_Add_2211<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_807_0, Constant_2855_0, BatchNormInference_816_0);
// Add_float_float_float_cuda_Add_2217<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_811_0, Constant_2858_0, BatchNormInference_818_0);
// Add_float_float_float_cuda_Add_821<<<dim3(64, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_816_0, BatchNormInference_818_0, Add_821_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_20_block_kernel(float* input0, float* input1, float* input2, float* input3, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: BatchNormInference_817_0	type: float	shape: Shape{1, 32, 32, 32}
__device__ __noinline__ void Add_float_float_float_cuda_Add_2214_block_kernel(float* input0, float* input1, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_fused_kernel_Add_42(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3)
{

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 255)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_804_block_kernel(input0, input1, output0, threadIdx.x, blockIdx.x - 0 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 256 && (int)blockIdx.x <= 511)
    {
        DepthwiseConv2dNative_float_float_float_cuda_DepthwiseConv2dNative_805_block_kernel(input2, input3, output1, threadIdx.x, blockIdx.x - 256 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 512 && (int)blockIdx.x <= 575)
    {
        FusedKernel_float_float_float_float_float_cuda_Add_Add_Add_20_block_kernel(input5, input4, input7, input6, output2, threadIdx.x, blockIdx.x - 512 + 0, NULL);
    }
    else if ((int)blockIdx.x >= 576 && (int)blockIdx.x <= 639)
    {
        Add_float_float_float_cuda_Add_2214_block_kernel(input8, input9, output3, threadIdx.x, blockIdx.x - 576 + 0, NULL);
    }
...
extern void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_fused_kernel_Add_42_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* output0, float* output1, float* output2, float* output3) {
    BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_DepthwiseConv2dNative_DepthwiseConv2dNative_fused_kernel_Add_42<<<grids, blocks, mem, stream>>>(input0, input1, input2, input3, input4, input5, input6, input7, input8, input9, output0, output1, output2, output3);
}
// Node name:	Constant_140
// Description:	Constant
// Input:
// Output:
//	- name: Constant_140_0	type: float	shape: Shape{3, 3, 128, 1}
...
// Fused functions:
// FusedKernel_float_float_float_float_float_cuda_Add_Add_Relu_26<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_925_0, Constant_2837_0, BatchNormInference_875_0, Relu_938_0, Add_933_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3049<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_913_0, Constant_2269_0, Constant_3050_0, Relu_930_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3051<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_914_0, Constant_2272_0, Constant_3052_0, Relu_931_0);
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3053<<<dim3(2, 8, 4), dim3(8, 2, 16), 0, 0>>>(DepthwiseConv2dNative_915_0, Constant_2275_0, Constant_3054_0, Relu_932_0);
// Deduped function map: <src_function_name : deduped_function_name>
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3051 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3049
// Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3053 : Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3049
...
//	- name: Add_933_0	type: float	shape: Shape{1, 64, 16, 16}
// Fused functions:
// Add_float_float_float_cuda_Add_2268<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Convolution_925_0, Constant_2837_0, BatchNormInference_929_0);
// Add_float_float_float_cuda_Add_933<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchNormInference_929_0, BatchNormInference_875_0, Add_933_0);
// Relu_float_float_cuda_Relu_938<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_933_0, Relu_938_0);
__device__ __noinline__ void FusedKernel_float_float_float_float_float_cuda_Add_Add_Relu_26_block_kernel(float* input0, float* input1, float* input2, float* output0, float* output1, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 512){
        return;
    }
...
// Output:
//	- name: Relu_930_0	type: float	shape: Shape{1, 64, 16, 16}
__device__ __noinline__ void Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3049_block_kernel(float* input0, float* input1, float* input2, float* output0, int thread_id, int block_id, char *shared_buffer)
{
    if (thread_id >= 256){
        return;
    }
...
extern "C" __global__  void BlockFusionKernel_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_float_cuda_fused_kernel_Matched_Pattern_Matched_Pattern_Matched_Pattern_61(float* input0, float* input1, float* input2, float* input3, float* input4, float* input5, float* input6, float* input7, float* input8, float* input9, float* input10, float* input11, float* output0, float* output1, float* output2, float* output3, float* output4)
{
    __shared__ char shared_buffer[2048];

    if ((int)blockIdx.x >= 0 && (int)blockIdx.x <= 31)
    {
        FusedKernel_float_float_float_float_float_cuda_Add_Add_Relu_26_block_kernel(input1, input0, input2, output1, output0, threadIdx.x, blockIdx.x - 0 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 32 && (int)blockIdx.x <= 95)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3049_block_kernel(input3, input4, input5, output2, threadIdx.x, blockIdx.x - 32 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 96 && (int)blockIdx.x <= 159)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3049_block_kernel(input6, input7, input8, output3, threadIdx.x, blockIdx.x - 96 + 0, shared_buffer);
    }
    else if ((int)blockIdx.x >= 160 && (int)blockIdx.x <= 223)
    {
        Matched_Pattern_float_float_float_float_cuda_Matched_Pattern_3049_block_kernel(input9, input10, input11, output4, threadIdx.x, blockIdx.x - 160 + 0, shared_buffer);
    }
