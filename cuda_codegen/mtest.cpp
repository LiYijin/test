...
int main(void){
    ...
    //input argument
    float* Parameter_260_0_host, *Parameter_260_0;
    CUDA_SAFE_CALL(cudaMallocHost((void**)&Parameter_260_0_host, sizeof(float)* 3072));
    CUDA_SAFE_CALL(cudaMalloc((void**)&Parameter_260_0, sizeof(float) * 3072));
    ...
    // fill input values
    for (int i = 0; i < 3072; ++i) Parameter_260_0_host[i] = 1.0f;

    CUDA_SAFE_CALL(cudaMemcpy(Parameter_260_0, Parameter_260_0_host, sizeof(float) * 3072, cudaMemcpyHostToDevice));
    ...
    {
        CUDA_SAFE_CALL(cudaMemcpy(Parameter_260_0, Parameter_260_0_host, sizeof(float) * 3072, cudaMemcpyHostToDevice));
        kernel_entry(Parameter_260_0, &Result_1763_0);
    ...
    //free context
    CUDA_SAFE_CALL(cudaFree(Parameter_260_0));
    cuda_free();

    cudaFreeHost(Parameter_260_0_host);
