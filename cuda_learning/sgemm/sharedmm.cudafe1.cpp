...
float kk[10]; 
# 8
(__cudaPushCallConfiguration(dim3(64, 1, 1), dim3(256, 1, 1), 0, 0)) ? (void)0 : conv_test(kk, kk + 1, kk + 2); 
# 9
cudaDeviceReset(); 
# 10
return 0; 
...
# 1 "sharedmm.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__16_sharedmm_cpp1_ii_main
# 1 "sharedmm.cudafe1.stub.c"
#include "sharedmm.cudafe1.stub.c"
# 1 "sharedmm.cudafe1.stub.c"
