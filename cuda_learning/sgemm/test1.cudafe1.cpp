...
#pragma GCC diagnostic pop
# 2 "test1.cu"
__attribute((noinline)) __attribute__((unused)) void Convolution_float_float_float_cuda_Convolution_1341_block_kernel(float *input0, float *input1, float *output0, int thread_id, int block_id, char *shared_buffer) 
# 3
{int volatile ___ = 1;(void)input0;(void)input1;(void)output0;(void)thread_id;(void)block_id;(void)shared_buffer;
# 897
::exit(___);}
#if 0
# 3
...
# 25
(compute_local[0]) = (0.0F); 
# 26
(compute_local[1]) = (0.0F); 
# 27
...
#endif
# 899 "test1.cu"
extern "C" void conv_test(float *input0, float *input1, float *output0) ;
#if 0
# 900
{ 
# 902
__attribute__((unused)) static char shared_buffer[6144]; 
# 903
Convolution_float_float_float_cuda_Convolution_1341_block_kernel(input0, input1, output0, __device_builtin_variable_threadIdx.x, __device_builtin_variable_blockIdx.x, shared_buffer); 
# 904
} 
#endif

# 1 "test1.cudafe1.stub.c"
#define _NV_ANON_NAMESPACE _GLOBAL__N__13_test1_cpp1_ii_e790cd0e
# 1 "test1.cudafe1.stub.c"
#include "test1.cudafe1.stub.c"
# 1 "test1.cudafe1.stub.c"
